...
<html lang="en">
    <head>
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Maven+Pro:wght@400;500;600;700;800;900&family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;0,800;1,300;1,400;1,600;1,700;1,800&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto+Mono:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap"
            rel="stylesheet"
        />
        <!-- Favicon -->
        <link
        ...
        <title>Deyler Alvarez Fernández</title>
    </head>
    <body>
        <!-- ========== Header ========== -->
        <header class="header" id="header">
            <nav class="nav container navbar-expand-lg">
                ...
                <div class="nav__btns">
                    ...
                    <i
                        data-mode="dark"
                        class="fas fa-moon moon-changed-theme"
                        id="theme-button"
                    ></i>
        ...
        <main class="main">
            ...
            <section class="about section" id="about">
                ...
                <div class="about__container container grid">
                    ...
                    <div class="about__buttons">
                        <a
                            href="file/CV.pdf"
                            download="Deyler Alvarez Fernández CV"
                            target="_blank"
                    ...
                    <div class="row" id="skill_container">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/html5-without-wordmark-color.svg"
                                        alt="HTML Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/Css3-595b40b65ba036ed117d3eb8_jiqifm.svg"
                                        alt="CSS Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/javascript-seeklogo.com_wthmgd.svg"
                                        alt="JavaScript Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/bootstrap-5-seeklogo.com_rz32ih.svg"
                                        alt="Bootstrap Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/git-seeklogo.com_eqv1dl.svg"
                                        alt="Git Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/github-seeklogo.com_yhhbou.svg"
                                        alt="GitHub Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/visual-studio-code-seeklogo.com_ps85dh.svg"
                                        alt="VScode Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/tux-seeklogo.com_aiyr1d.svg"
                                        alt="Linux Logo"
                                    />
                                </div>
                                <div class="contentBx">
                        ...
                        <div class="skill__container-card">
                            <div class="card_skill shadow2">
                                <div class="imgBx">
                                    <img
                                        src="img/Microsoft_Office_logo__282019_E2_80_93present_29_pswha1.svg"
            ...
            <section class="qualifications section" id="qualifications">
                ...
                <div class="qualification__content container">
                    <div class="row mt-lg-0">
                        <!-- Education -->
                        <div
                            class="col-lg-6 col-sm-10 col-md-10 mt-2 qualification__content"
                            id="education"
                        >
                            <div class="qualification__button button--flex">
                                <i
                                    class="fas fa-user-graduate qualification__icon"
                                ></i>
                                Education
                            </div>
                            <div class="education__timeline">
                                <div class="container py-2">
                                    ...
                                    <div class="row">
                                        <!-- Timeline design -->
                                        <div
                                            class="col-auto text-center flex-column d-sm-flex"
                                        >
                                            <div
                                                class="row h-50 qualification__journey"
                                            >
                                                <div class="col">
                                                    <span
                                            ...
                                            <h5>
                                                <span
                                                    class="badge qualification__calendar"
                                                >
                                                    <i
                                                        class="fas fa-calendar-alt qualification__calendar-icon"
                                                    ></i>
                                                    2015
                                                </span>
                                            </h5>
                                        ...
                                        <div class="col py-2">
                                            <div
                                                class="card education-card transparent_card mirror-face shadow2"
                                            >
                                                <div class="card-body">
                                                    <div class="task">
                                                        <div class="abstract">
                                                            <h3
                                                                class="qualification__title"
                                                            >
                                                                Diseño Web
                                                                Profesional El
                                                                Curso Completo
                                                        ...
                                                        <div class="details">
                                                            ...
                                                            <a
                                                                target="_blank"
                                                                rel="noopener"
                                                                href="https://www.udemy.com/certificate/UC-bab2fe8b-114e-4661-b41a-a7f2761f176f/"
                                                                class="button button--flex certificate__button"
                                                                >See Certificate
                                                                <i
                                                                    class="fas fa-scroll certificate__icon"
                                                                ></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="col">
                                                    <span
                                                        class="qualification__start"
                                                    >
                                                        <i
                                                            class="fas fa-rocket qualification__start-icon"
                                                        ></i>
                                                    </span>
                                                </div>
                                                <div class="col">&nbsp;</div>
                        ...
                        >
                            <div class="qualification__button button--flex">
                                <i
                                    class="fas fa-briefcase qualification__icon"
                                ></i>
                                Experience
                            </div>
                    ...
                    <div class="blog-slider__wrp swiper-wrapper">
                        ...
                        <div class="blog-slider__item swiper-slide">
                            <div class="blog-slider__img">
                                <img
                                    src="img/Portfolio-item-im.png"
                                    alt="Porfolio item"
                                />
                            </div>
                            <div class="blog-slider__content">
                                <span class="blog-slider__code"
                                    >1st August 2021</span
                                >
                                ...
                                <a
                                    href="#portfolio"
                                    target="_blank"
                                    class="button blog-slider__button button--flex"
                                >
                                    Demo
            ...
            <section class="contact section" id="contact">
                ...
                <div class="row mt-lg-6 justify-content-center contact_mail">
                    <!-- Contact information -->
                    <div
                        class="col-lg-6 mx-lg-0 mx-2 contact__container container"
                    >
                        ...
                        <div class="contact__information">
                            ...
                            <div>
                                ...
                                <span class="contact__subtitle"
                                    >deylerafernandez@gmail.com</span
                                >
                            </div>
                        </div>
                        <div class="contact__information">
                            ...
                            <div>
                                ...
                                <span class="contact__subtitle"
                                    >Costa Rica, Alajuela, La Fortuna</span
                                >
                            </div>
                        </div>
                    </div>
                    <!-- Form -->
                    <div
                        class="col-lg-6 mx-lg-0 mx-2 contact-form"
                        id="message-me"
                    >
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <input
                                        type="text"
                                        name="message-name"
                                        class="form-control form__color mb-30 cf"
                                ...
                                <div class="col-12">
                                    <button
                                        type="submit"
                                        class="button button--flex send-message form_button"
                                    >
                                        Send Message
                                        <i
                                            class="fas fa-paper-plane button__icon"
                                        ></i>
                                    </button>
                                </div>
                            </div>
        ...
        <!-- Fontawesome -->
        <script
            src="https://kit.fontawesome.com/a9e25f3d46.js"
            crossorigin="anonymous"
        ></script>
